...
void test_c_RemoveUrbanizacoes() {
	...
	Vivenda *v32 = new Vivenda(100, 20, true, "João");
...
void test_d_AreaSuperiorA() {
	...
	Vivenda *v1 = new Vivenda(100, 20, true, "João");
...
void test_e_OperadorMaior() {
	...
	Vivenda *v22 = new Vivenda(100, 20, true, "João");
	Vivenda *v23 = new Vivenda(100, 20, true, "João");
	Vivenda *v24 = new Vivenda(100, 20, true, "João");
	u2.adicionaImovel(a21);
	u2.adicionaImovel(v22);
